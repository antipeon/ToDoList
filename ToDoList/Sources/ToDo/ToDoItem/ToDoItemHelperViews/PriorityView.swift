...
final class PriorityView: UIView {
    ...
    lazy var prioritySwitch: UISegmentedControl = {
        ...
        let exclamationMark = UIImage(systemName: "exclamationmark.2")?.withTintColor(
            .red,
    ...
    private func setUpConstraints() {
        NSLayoutConstraint.activate(
            prioritySwitchAndLabel.leftAnchor.constraint(
                equalTo: layoutMarginsGuide.leftAnchor,
                constant: Constants.priorityLabelLeftInset
            ),
